    ...
    payload = json.dumps(
        {
            ...
            "Layers": [
                ...
                {"type": "Isotropic Middle-Stack Layer", "thickness": 23.0},
                {
                    "type": "Crystal Layer",
                    "material": "MnF2",
                    "rotationX": 0,
...
def mock_dispersion_payload():
    payload = json.dumps(
        {
            "ScenarioData": {"type": "Dispersion", "frequency": 1460},
            "Layers": [
                {"type": "Ambient Incident Layer", "permittivity": 50.0},
                {
                    "type": "Isotropic Middle-Stack Layer",
...
def updating_payload(
    ...
    if scenario == "Incident":
        payload["ScenarioData"] = {"type": scenario}
    elif scenario == "Azimuthal":
        payload["ScenarioData"] = {"type": scenario, "incidentAngle": incident_angle}
    elif scenario == "Dispersion":
        payload["ScenarioData"] = {"type": scenario, "frequency": frequency}
