...
from material_params import Quartz, Ambient_Incident_Prism, Air, CalciteUpper, CalciteLower
...
def main_all_anisotropy_axes():
    ...
    calcite_layer = berreman_all_anisotropy(kx, eps_tensor, non_magnetic_tensor * tf.ones_like(eps_tensor), semi_infinite=True)[tf.newaxis, ...]
