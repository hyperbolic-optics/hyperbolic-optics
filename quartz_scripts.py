...
from material_params import Air, Ambient_Incident_Prism, Quartz
...
def main_all_anisotropy_axes():
    ...
    y_rotation = tf.cast(tf.linspace(0.0, m.pi / 2.0, 7), dtype=tf.complex64)
    z_rotation = tf.cast(tf.linspace(0.0, 2 * m.pi, 10), dtype=tf.complex64)
    ...
    quartz_layer = berreman_all_anisotropy(
        kx,
        eps_tensor,
